...
A [sample input file](./data/010_Paylocity_sample_payload_for_DB_loading.txt)) is provided for you. When processing this file, your code should print an output similar to what is shown here.
