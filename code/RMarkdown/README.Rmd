...
A [sample input file](#sample_input_payload_data) is provided for you. When processing this file, your code should print an output similar to what is shown here.
...
knitr::raw_html("<code id='sample_input_payload_data'>")
knitr::raw_html(paste0(sampleText, "\n"))
knitr::raw_html("</code>")
