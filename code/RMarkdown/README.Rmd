...
A sample input file is provided for you. When processing this file, your code should print an output similar to what is shown here.
...
1. Field constraints, including primary and foreign keys
